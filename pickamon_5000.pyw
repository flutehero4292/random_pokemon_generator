...
window = tk.Tk()
window.title("Random Pokemon Generator (Gen 1-5)")
...
btn_all_gens_1_to_5 = tk.Button(master=frm_buttons, text="All Gens 1-5", command=all_gens_1_to_5)
btn_all_gens_1_to_5.pack(side=tk.RIGHT, padx=6)
